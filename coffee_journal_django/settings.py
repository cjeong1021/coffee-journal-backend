"""
Django settings for coffee_journal_django project.
...
ROOT_URLCONF = "coffee_journal_django.urls"
...
WSGI_APPLICATION = "coffee_journal_django.wsgi.application"
...
CSRF_TRUSTED_ORIGINS = ["https://web-production-192.up.railway.app"]
